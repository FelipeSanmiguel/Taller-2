...
public class SandboxConjuntos
{
    ...
    {
        List<String> ListaInvertida = getCadenasComoLista();
        List<String> ListaInvertidaCopia = new ArrayList<>(ListaInvertida);
    	
        for(int i = 0; i < ListaInvertidaCopia.size(); i++) {
        	ListaInvertida.set(i, ListaInvertidaCopia.get(ListaInvertidaCopia.size() -1 -  i));
        }
    ...
    {
    	NavigableSet<String> arbolMayusculas = new TreeSet<>();
